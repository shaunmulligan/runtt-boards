...
| `app/` | the build vehicle the build scripts and provisioning docs use |
| `idle/` | the placeholder that ships in slot 0 at provisioning time, so a fresh board **enumerates and reports itself** rather than looking dead |
